...
<div class="profile">
    <div class="header">
        ...
        <div class="info d-flex w-100 flex-wrap gap-3   ">
            <div class="avatar">
            <img src="<?= $avatar ?? APP_URL . "/assets/images/influencer.png" ?>">
            </div>
            <div class="text">
                <div class="d-flex align-center space-between mb-2">
                    <h3 class="m-0"><?= $first_name ?> <?= $last_name ?></h3>
                    <?php if ($allowable) : ?>
                        ...
                        <span class="d-flex align-center">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" tag="i" width="1em" height="1em" viewBox="0 0 24 24" style="font-size: 20px; height: 20px; width: 20px;">
                                <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                                    ...
                                    <path d="M16 3v4M8 3v4m-4 4h16m-9 4h1m0 0v3"></path>
                                </g>
                            </svg>
                            <span><?= $age ?></span>
                        </span>
        ...
        <div class="col-12 col-md-4 about">
            ...
            <ul>
                <li>
                    ...
                    <span><strong>Full Name:</strong> <?= $first_name ?> <?= $last_name ?></span>
                </li>
                <?php if ($job) : ?>
                    <li>
                        <span>
                        ...
                        <span><strong>Job:</strong> <?= $job ?></span>
                    </li>
                <?php endif; ?>
                <?php if ($age) : ?>
                    <li>
