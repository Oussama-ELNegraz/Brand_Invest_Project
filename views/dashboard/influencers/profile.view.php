...
<div class="card profile-edit">
    ...
    <form action="#" method="POST" enctype="multipart/form-data">
        ...
        <div class="d-flex p-24 gap-4 image flex-wrap">
        ...
        <div class="d-flex flex-wrap px-24">
            <div class="form-group col-12 col-md-6">
                <input class="w-100" type="text" name="first_name" placeholder="First Name" required value=<?= $first_name ?>>
            </div>
            <div class="form-group col-12 col-md-6">
                <input class="w-100" type="text" name="last_name" placeholder="Last Name" required value=<?= $last_name ?>>
            </div>
            <div class="form-group col-12 col-md-6">
            ...
            <div class="form-group col-12 col-md-6">
                <input class="w-100" type="text" name="job" placeholder="Job" value=<?= $job ?>>
            </div>
            <div class="form-group col-12 col-md-6">
                <input class="w-100" type="text" name="age" placeholder="age" value=<?= $age ?>>
            </div>
            <div class="form-group col-12 col-md-6">
